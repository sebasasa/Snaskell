...
/* package HaskellSnake-0.1.0.0 */
#ifndef VERSION_HaskellSnake
#define VERSION_HaskellSnake "0.1.0.0"
#endif /* VERSION_HaskellSnake */
#ifndef MIN_VERSION_HaskellSnake
#define MIN_VERSION_HaskellSnake(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HaskellSnake */
...
#define CURRENT_COMPONENT_ID "HaskellSnake-0.1.0.0-inplace-HaskellSnake"
